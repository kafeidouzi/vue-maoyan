    ...
    <div class="main-block">
      <div class="avatar" sort-flag>
        <div class="default-img-bg">
          <img
            :src="movie.img | wh" onerror="this.style.visibility='hidden'"/>
        </div>
      </div>
      <div class="mb-outline-b content-wrapper">
        <div class="column content">
          ...
          <div class="detail column">
            ...
            <div class="score line-ellipsis" v-if="movie.showst === 4 || movie.showst === 1">
        ...
        <MovieButton :showst="movie.showst"></MovieButton>
      </div>
    </div>
  </div>
</template>
